...
public class FilmController {
    ...
    @Reference(interfaceClass = FilmServiceApi.class,check = false,filter = "tracing")
    private FilmServiceApi filmServiceApi;

    @Reference(interfaceClass = FilmAsyncServiceApi.class,async = true,check = false,filter = "tracing")
